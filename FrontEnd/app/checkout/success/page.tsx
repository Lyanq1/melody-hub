      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden md:max-w-2xl p-8">
        {(resultCode === '0' && verified) ? (
          <div className="text-center">
            ...
            <div className="mt-6">
              <Link href="/homepage" className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition duration-300">
                Return to Homepage
              </Link>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="mt-6 space-x-4">
              <Link href="/checkout" className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition duration-300">
                Try Again
              </Link>
              <Link href="/homepage" className="bg-gray-600 text-white px-6 py-2 rounded-md hover:bg-gray-700 transition duration-300">
                Return to Homepage
              </Link>
            </div>
          </div>
