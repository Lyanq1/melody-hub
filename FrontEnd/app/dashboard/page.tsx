...
import { LayoutDashboard, Disc, ShoppingCart, Users, Percent, Bell } from "lucide-react";
	...
	return (
		<div className="font-[MicaValo] min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 p-6 space-y-8">
			...
			<div className="flex flex-wrap gap-4">
				{notifications.map((n) => (
					<div key={n.id} className="flex items-center gap-2 bg-white rounded-lg px-4 py-2 shadow border-l-4 border-yellow-400">
